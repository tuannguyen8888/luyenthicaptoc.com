                        ...
                        <div class="box-body table-responsive no-padding">
                              ...
                              <div class="container">
                                  <div class="form-group row">
                                      <label for="shool" class="col-sm-1 col-form-label">Trường</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control {{!$table_rows[0][1]?'invalid':''}}" id="shool" value="{{$table_rows[0][1]}}" readonly>
                                      </div>
                                  </div>
                                  <div class="form-group row">
                                      <label for="examQuestionName" class="col-sm-1 col-form-label">Tên đề thi</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control {{!$table_rows[1][1]?'invalid':''}}" id="examQuestionName" value="{{$table_rows[1][1]}}" readonly>
                                      </div>
                                  </div>
                                  <div class="form-group row">
                                      <label for="examQuestionName" class="col-sm-1 col-form-label">Môn học</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control {{!$table_rows[2][1]?'invalid':''}}" id="subject" value="{{$table_rows[2][1]}}" readonly>
                                      </div>
                                  </div>
                                  <div class="form-group row">
                                      <label for="examQuestionName" class="col-sm-1 col-form-label">Kỳ thi</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control {{!$table_rows[3][1]?'invalid':''}}" id="exam" value="{{$table_rows[3][1]}}" readonly>
                                      </div>
                                  </div>
                              </div>
...
//                              },200);
                              {{--$('#review-data').dataTable({--}}
                                  ...
                                  {{--dom: 'Bfrtip',--}}
                              {{--});--}}
                              {{--if($('.invalid').toArray().length > 0){--}}
                                {{--$('#import_data_button').prop('disabled', true);--}}
                              {{--}else{--}}
                                  {{--$('#import_data_button').prop('disabled', false);--}}
                              {{--}--}}
                          });
                          function check_selected_column(e) {
//                              var total_selected_column = 0;
//                              $('.select_column').each(function() {
//                                  var n = $(this).val();
//                                  if(n) total_selected_column = total_selected_column + 1;
...
//                              }
                              if($('.invalid').toArray().length > 0){
                                  swal("Dữ liệu không đúng", "Vui lòng kiểm tra lại dữ liệu. Không thể import nếu dữ liệu không đúng (viền đỏ)", "error");
                                  // e.preventDefault()
                                  return false;
                              }else{
                                  return true;
                        ...
                        <div class="box-footer">  
                          <div class='pull-right'>             
                              ...
                              <input id="import_data_button" type='submit' class='btn btn-primary' name='submit' onclick='return check_selected_column()' value='Import Data'/>
                          </div>
                        </div><!-- /.box-footer-->
                </form>
            </div><!-- /.box -->
            ...
            <div id='box_main' class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                       <a class="btn btn-danger" target="_blank" href="{{asset('uploads/templates/import_exam_questuin_template.xls')}}"><i class="fa fa-download" aria-hidden="true"></i> Download template import</a>
                    </div>
                </div>
...
<!--                            <div class='callout callout-success'>
                            ...
                            <div class='callout callout-success'>
                              <h4>Vui lòng chọn file Upload</h4>
                                ...
                                * Đảm bảo đúng định dạng, đúng mẫu file được cung cấp. Kiểm tra cẩn thận dữ liệu đã nhập đầy đủ hay chưa? Nếu thiếu có thể sẽ phát sinh lỗi không mong muốn.<br/>

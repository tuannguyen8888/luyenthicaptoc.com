    ...
    <table id='table_dashboard' class="table table-hover table-striped table-bordered">
        ...
        <tr class="active">
            ...
            foreach ($columns as $col) {
                ...
                if (isset($sort_column[$sort_field?$sort_field:$field])) {
                    switch ($sort_column[$sort_field?$sort_field:$field]['sorting']) {
                        case 'asc':
                            $url = CRUDBooster::urlFilterColumn($sort_field?$sort_field:$field, 'sorting', 'desc');
                            echo "<a href='$url' title='Click to sort descending'>$colname &nbsp; <i class='fa fa-sort-desc'></i></a>";
                            break;
                        case 'desc':
                            $url = CRUDBooster::urlFilterColumn($sort_field?$sort_field:$field, 'sorting', 'asc');

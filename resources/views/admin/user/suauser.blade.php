						...
						<tr class="tbl">
							...
							<td>
								<select name="quyen" id="tenloaich" class="form-control nhaploai">
                                    <option {{$user->quyen == 0?'selected':''}} value="0">Học sinh</option>
                                    <option {{$user->quyen == 1?'selected':''}} value="1">Giáo viên</option>
                                    <option {{$user->quyen == 2?'selected':''}} value="2">Admin</option>
                       			 </select>
							</td>
						</tr>

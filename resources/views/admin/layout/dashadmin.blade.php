...
<body>
	...
	<div class="navbar navbar-inverse" role="navigation" style="background-color: #213351;margin-top: -20px">
		<div class="navbar-header">
            <a class="navbar-brand" href="dashbroad_ad" style="font-size: 18px"><img src="imgs/logo.png" alt="" width="50" height="50" style="margin-top: -10px;margin-right:8px;display: inline;">
               Luyện Thi Cấp Tốc</a>
			...
			{{--<li class="dropdown">--}}
				...
				{{--<div class="popup dropdown-menu dropdown-menu-right">--}}
					...
					{{--<ul class="popup-messages">--}}
						{{--<li class="unread">--}}
							{{--<a href="#">--}}
								{{--<img src="imgs/login-icon.png" alt="" class="user-face" >--}}

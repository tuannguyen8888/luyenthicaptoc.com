<div class="menu-top hide-for-mobile">
    <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 infor_user">
            ...
            @else
                <a href="{{url('dangnhap').'?redirect_url='.url()->full()}}" class="pull-right">
                    <div class="login "><i class="fas fa-user"></i> Đăng nhập</div>
                </a>
            @endif
        </div>
...
<div class="menu-ngang hide-for-mobile">
    <div class="row" data-spy="affix" data-offset-top="85">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <a href="{{url('home') }}">
                <img id="logo" src="{{asset('imgs/logo.png') }}" alt="luyenthicapttoc.com"
                     style="height: 97px;margin-top: -20px;border: 1px solid #f5f5f5;border-radius: 10px;background: #f5f5f5;">
            </a>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav" style="border-bottom: solid 1px #8080805e;">
                    ...
                    @foreach ($menus as $menu)
                        <li><a style="text-transform: uppercase;" href="{{$menu->path }}"><span
                                        class="{{$menu->icon}}"></span> {{$menu->name}} </a></li>
                    @endforeach
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li><a href="{{url('dangnhap').'?redirect_url='.url()->full()}}"><span
                                        class="fas fa-user"></span> Đăng nhập</a></li>
                    @endif
                </ul>
            </div>
        </div>

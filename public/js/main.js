            ...
            success: function (resp) {
            	if(resp) {
                    ...
                    if (resp.total > 0) {
                        ...
                        $('.notifications-menu #notification_count').hide();
                        $('.notifications-menu .header').text('Bạn không có thông báo nào.');
                    ...
                    total_notification = resp ? resp.total : 0;
                }
            },
            error: function (e) {
                console.error('session error ',e);
                swal("Phiên đăng nhập đã hết hạn", 'Phiên đăng nhập của bạn đã hết hạn. Vui lòng đăng nhập lại để tiếp tục làm việc.', "info");
                swal({
                        title: "Phiên đăng nhập đã hết hạn",
                        text: "Vui lòng đăng nhập lại để tiếp tục làm việc.",
                        type: "info"
                    },
                    function() {

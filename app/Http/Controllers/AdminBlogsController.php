<?php namespace App\Http\Controllers;
	...
	class AdminBlogsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Danh mục","name"=>"blog_category_id","join"=>"blog_categories,name"];
			...
			$this->form = [];
            $this->form[] = ['label'=>'Danh mục','name'=>'blog_category_id','type'=>'select2','validation'=>'required','width'=>'col-sm-4','datatable'=>'blog_categories,name'];
			...
			//$this->form[] = ['label'=>'Tiêu đề','name'=>'blog_title','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Đường dẫn','name'=>'blog_slug','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Ảnh đại diện','name'=>'blog_image','type'=>'upload','validation'=>'required|min:1|max:255|image','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Nội dung','name'=>'description','type'=>'wysiwyg','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Kích hoạt','name'=>'is_active','type'=>'checkbox','validation'=>'required|integer','width'=>'col-sm-10'];
			# OLD END FORM

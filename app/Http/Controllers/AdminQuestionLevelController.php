...
use Illuminate\Support\Facades\Log;
	...
	class AdminQuestionLevelController extends CBExtendController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Tên mức độ','name'=>'tenmd','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Tenmd","name"=>"tenmd","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];

<?php namespace App\Http\Controllers;
	...
	class AdminBlogCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Tên danh mục","name"=>"name"];
			$this->col[] = ["label"=>"Mô tả","name"=>"description"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Tên danh mục','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Mô tả','name'=>'description','type'=>'text','validation'=>'max:255','width'=>'col-sm-10'];

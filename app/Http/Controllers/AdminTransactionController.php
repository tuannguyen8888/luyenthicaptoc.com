<?php namespace App\Http\Controllers;
	...
	class AdminTransactionController extends \crocodicstudio\crudbooster\controllers\CBController {
...
//			$this->col[] = ["label"=>"Id tham chiếu","name"=>"refer_id","join"=>"refer,id"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Thời gian','name'=>'date_time','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Date Time","name"=>"date_time","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			//$this->form[] = ["label"=>"Trans Code","name"=>"trans_code","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Trans Type","name"=>"trans_type","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Amount","name"=>"amount","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Refer Id","name"=>"refer_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"refer,id"];
